...
async function renderProductsGrid(){
  ...
  if(search){
    filteredProducts = products.filter((product) =>{
      const keyword = product.keywords.map(item => item.toLowerCase());
      return product.name.toLowerCase().includes(search.toLocaleLowerCase()) || keyword.includes(search.toLocaleLowerCase());
    });
  }
  ...
  headerHTML += `      <div class="amazon-header-left-section">
